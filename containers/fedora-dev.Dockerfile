...
RUN sudo dnf install -y git nano findutils file xz ncurses-devel bison flex elfutils-libelf-devel openssl-devel bc hostname glibc-devel.i686 glibc-static.i686 glibc-static nasm binutils
